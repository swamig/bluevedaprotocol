---
title: 'Homemade Sriracha — Fermented & Quick Variants'
section: 'practical'
type: 'procedure'
priority: 'supporting'
---
...
| Thai red chili | 4–6 chilies | Optional · ramps the heat by ~2× |
| Garlic cloves | 6–8 cloves | Peeled · whole |
| Sea salt | 1 tbsp (~18 g) | **~3.5% by weight of peppers** — drives the ferment + preserves |
...
3. **Cool.** Off heat. Cool 10 min.
4. **Strain (optional).** Through fine mesh for classic texture · OR skip for rustic.
5. **Bottle or cube.** Squeeze bottle (fridge, 2 weeks) OR mini ice tray (freezer, 6 months).

Skipping the ferment trades 5 days for ~30% of the flavor complexity. The cube system makes Mode B perfectly serviceable — you'll use one cube at a time inside other sauces ([Sesame Sauce](./sesame-sauce-cubes.md), [Veg Oyster Sauce](./oyster-sauce-vegetarian.md)) where its character blends in anyway.

## Optional Bio-Signal Stack

All optional — adds to either mode.

| Layer | Add | Per batch | Why |
|---|---|---|---|
| **TRPV1 diversity** | Smoked paprika | 1 tsp | Different capsaicinoid profile + smoky note — closer to chipotle-style heat |
| Heat-stable sulfur | Black garlic powder | 1 tsp | SAC · adds a fermented depth without the wait |
...
| Output | Value |
|---|---|
| Cubes per batch | ~24 mini (1 tsp each) |
| Bottles per batch | ~1.5 cups (one squeeze bottle) |
| Freeze stability | 6 months |
| Fridge stability (Mode A) | 6 months |
| Fridge stability (Mode B) | 2 weeks |
